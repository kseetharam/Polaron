...
if __name__ == "__main__":
    ...
    #     ax = fig.add_subplot(nrows=3, ncols=2, index=tind)
    #     axes.append(ax)
    ...
    for tind, t in enumerate(tslices):
        ...
        # t_text = ax.text(0.81, 0.9, r'$t$ [$\frac{\xi}{c}$]: ' + '{:1.2f}'.format(tsVals[tind] / tscale), transform=ax.transAxes, fontsize='small', color='r')
        # Nph_text = ax.text(0.81, 0.9, r'$N_{ph}$: ' + '{:.2f}'.format(Nph_Vals[tninds[tind]]), transform=ax.transAxes, fontsize='small', color='xkcd:steel grey')
    ...
    # fig.legend(handles, labels, ncol=1, loc='center right', bbox_to_anchor=(0.09, 0.5))
